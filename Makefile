...
SRC			=	char/ft_isalnum.c char/ft_isalpha.c char/ft_isascii.c char/ft_isdigit.c char/ft_isprint.c \
				char/ft_putchar_fd.c char/ft_putendl_fd.c char/ft_putstr_fd.c char/ft_puthex_fd.c char/ft_tolower.c char/ft_toupper.c \
				...
				str/ft_split.c str/ft_strchr.c str/ft_strdup.c str/ft_striteri.c str/ft_strjoin.c str/ft_strlcat.c \
...
$(NAME): $(OBJ)
	@ar rcs $(NAME) $(OBJ)
	@echo "$(BLUE)[Library]$(END_COLOR) Libft is ready !"
